...
| Laravelの概要、画面、API、DB | `specifications/backend/laravel/overview.md`、`specifications/backend/laravel/screens-and-features.md`、`specifications/backend/laravel/database.md`、`.cursor/rules/app-overview.mdc`、`specifications/backend/laravel/` |
