...
| WordPress | `specifications/backend/wordpress/overview.md`、`specifications/backend/wordpress/classic-theme.md`、`specifications/backend/wordpress/content-and-api.md`、`backend/wordpress/`、`.cursor/rules/cms-overview.mdc` |
